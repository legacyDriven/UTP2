...
public class Main {
  public static void main(String[] args) {
    ...
    XList<Integer> m3 = m2.union(ints).union(XList.of(4, 4)); //    Integer[] ints = { 100, 200, 300 };
    ...
    XList toCombine = XList.of(sa, sb, sc); //czy mozna uniknac podania surowego typu? nie mozna
